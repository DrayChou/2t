<?php 
/*
*	这个文件是oauth认证类。不是我写的哦。来自http://oauth.net
*	Code based on: 
*	Abraham Williams (abraham@abrah.am) http://abrah.am
*	Load OAuth lib. You can find it at http://oauth.net 
*	Modified By Wang Haosen at 2011-7-8
*	From http://pagewant.com
*
*/
...
class OAuth { 
     ...
     * @ignore 
     */ 
    public $host = "http://www.douban.com/"; 
    /** 
     * Set timeout default. 
     * 
     * @ignore 
     ...
     * @ignore 
     */ 
    function authenticateURL() { return 'http://www.douban.com/service/auth/authorize'; } 
    /** 
     * @ignore 
     */ 
